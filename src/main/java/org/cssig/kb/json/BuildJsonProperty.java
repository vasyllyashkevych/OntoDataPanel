...
import static org.cssig.kb.gui.ToolBar.hSchema;
...
//	System.out.print(obj);
    ...
    public void getGeneratorData(String[] flds) throws IOException {
        ...
        while (typeArray[i][2] != null) {
            ...
            boolean b1 = isPresent(flds, prp_name);
            if (!b1) {
                i++;
                continue;
            }
            ...
            while ((typeArray[i][0] == null) & (typeArray[i][1] != null) & (typeArray[i][2] != null)) {
                ...
                prp_name = typeArray[i][1];
                boolean b = isPresent(flds, prp_name);
                if (!b) {
                    i++;
                    continue;
                }
...
//	System.out.print(obj);
    ...
    public static void getJsonSchemaGenerator() {
        ...
        try {
            FileWriter file = new FileWriter(FNManager.main("To save JSON scheme for generator !", ".json"));
            file.write(obj.toJSONString());
            file.flush();
            file.close();
        } catch (IOException e) {
